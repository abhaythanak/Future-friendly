...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-12 rounded-t-2xl bottom-0">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <h1  className="flex items-center">
                <img src="https://png.pngtree.com/png-clipart/20220823/original/pngtree-food-logo-png-image_8466881.png" className="h-36 mr-3" alt="FlowBite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"><img src="https://see.fontimg.com/api/renderfont4/rg9Rx/eyJyIjoiZnMiLCJoIjo4MSwidyI6MTI1MCwiZnMiOjY1LCJmZ2MiOiIjRUUxMjEyIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/Rm9vZENyYXZpbmc/ananda-black-personal-use-regular.png" alt="logo" /></span>
            </h1>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <h1  class="hover:underline">Flowbite</h1>
                    </li>
                    <li>
                        <h1  className="hover:underline">Tailwind CSS</h1>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <h1  className="hover:underline">Discord</h1>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <h1  className="hover:underline">FoodCraving™</h1>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <h1  className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
